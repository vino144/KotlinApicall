...
class MainActivity : AppCompatActivity(), PermissionListener, OnMapReadyCallback {
    companion object {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
      ...
      /*  btn_view_map.setOnClickListener(View.OnClickListener {
            map.setMenuVisibility(View.VISIBLE)
        })*/
        ...
        call.enqueue(object : Callback<PopularMovies> {
            override fun onResponse(call: Call<PopularMovies>, response: Response<PopularMovies>) {
                if (response.isSuccessful){
                   ...
                   // println("CHECK_RESPONSE: "+response.body().toString())
                    recyclerView.apply {
            ...
            .addOnCompleteListener(this) { task ->
                if (task.isSuccessful && task.result != null) {
                    ...
                    if (mLastLocation != null) {
                        println("CHECK_LATLNG: LATT"+mLastLocation.latitude+":   LONG:"+ mLastLocation.longitude)
